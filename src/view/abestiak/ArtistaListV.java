...
public class ArtistaListV extends JFrame implements IAtzeraProfilaBotoiak {
		...
		btnJarraitu.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (artistaSelected == null) {
					...
					Artista artistaAuxSelected = new Musikaria(artistaSelected.getIzena(),
							artistaSelected.getErreprodukzioak());
					dispose();
					try {
