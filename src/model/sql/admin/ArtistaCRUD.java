...
//	}
	...
	public static void artistaUpdate(String izenArtistikoa, String izenBerria) throws SQLException {

		String IdArtista = IdArtistaLortu(izenArtistikoa);
		
		Konexioa.konexioaIreki();

		String SQLquery = "UPDATE musikaria SET IzenArtistikoa = '" + izenBerria + "' WHERE IDMusikaria = '"+ IdArtista + "'";
